      ...
      <div ref={mainRef}>
        ...
        <main className={styles.mainContent}>
          ...
          <div style={{position: 'relative', zIndex: '11'}}><h2>{'About me'}</h2></div>
            ...
            <p>{"I specialize in the front-end and a little back-end, making sure that every project I work on looks good and works as intended. My experience includes developing multiple fully-functional websites, creating a database-API."}</p>

            <p>{"I’m open to learning and improving my skills, whether it’s by exploring a new framework, or finding better solutions to my problems"}</p>
