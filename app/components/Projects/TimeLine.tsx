  ...
  return (
    <>
      <div
        ...
        tabIndex={0}
      >
        <article className="bg-white dark:bg-slate-900/95 dark:text-gray-100 max-w-4xl max-h-full p-8 rounded-2xl shadow-lg pointer-events-auto overflow-auto">
          <div className="flex items-center justify-between relative w-full">
            ...
            <X
              className="p-1 my-3 rounded-full bg-primary-100 dark:bg-slate-800/95 text-primary-600 text-sm font-medium cursor-pointer"
              size={28}
              onClick={onClose}
            />
          </div>
          ...
          <footer className="w-full mt-8 p-6 bg-primary-50 dark:bg-slate-800/90 rounded-2xl">
              ...
              <div>
                ...
                <ul className="flex flex-wrap gap-4">
                  {project.details?.techStack.sort().map((tech, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 bg-primary-200/50 dark:bg-slate-700 p-2 rounded-2xl shadow-sm"
                    >
                      <Image
